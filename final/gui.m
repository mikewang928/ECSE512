...
% Last Modified by GUIDE v2.5 13-Dec-2020 22:41:59
...
Gain1=str2num(get(handles.editG1, 'String'));
Gain2=str2num(get(handles.editG2, 'String'));
Gain3=str2num(get(handles.editG3, 'String'));
Gain4=str2num(get(handles.editG4, 'String'));
Gain5=str2num(get(handles.editG5, 'String'));

input_file=get(handles.pathtext, 'String');
...
if (file~=0)
    set(handles.pathtext, 'String', fullfile(path,file));
end
disp(file)
...
function editG5_Callback(hObject, eventdata, handles)
% hObject    handle to editG5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editG5 as text
%        str2double(get(hObject,'String')) returns contents of editG5 as a double


% --- Executes during object creation, after setting all properties.
function editG5_CreateFcn(hObject, eventdata, handles)
% hObject    handle to editG5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
